...
(custom-set-faces
 ...
 '(mode-line ((((type ns)) (:background "#ff7700" :foreground "gray20" :box (:line-width (5 . 5) :color "#ff7700" :style flat-button) :height 1.0 :family "SF Compact Rounded")) (((type x pgtk)) (:background "#ff7700" :foreground "gray20" :box (:line-width (2 . 2) :color "#ff7700" :style flat-button) :height 1.0 :family "Latin Modern Sans")) (((type tty)) (:background "#ff7700" :foreground "gray20"))))
 '(mode-line-inactive ((((type ns)) (:inherit mode-line :background "gray" :foreground "#686868" :box (:line-width (5 . 5) :color "gray" :style flat-button))) (((type x pgtk)) (:inherit mode-line :background "gray" :foreground "#686868" :box (:line-width (2 . 2) :color "gray" :style flat-button))) (((type tty)) (:background "gray" :foreground "#686868"))))
