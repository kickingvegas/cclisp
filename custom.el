...
(custom-set-faces
 ...
 '(org-date ((((type x mac ns) (background light)) (:foreground "dark violet" :underline t)) (((type x mac ns) (class color) (background dark)) (:foreground "gold")) (((type tty) (class color)) (:foreground "gold"))))
 ...
 '(org-hide ((((type x mac ns) (class color) (background light)) (:foreground "white")) (((type x mac ns) (class color) (background dark)) (:foreground "#171717")) (((type tty) (class color)) (:foreground "black"))))
 '(org-meta-line ((t (:inherit fixed-pitch :foreground "grey50"))))
 ...
 '(org-table ((((type x mac ns) (class color) (background light)) (:inherit fixed-pitch :foreground "Blue1")) (((type x mac ns) (class color) (background dark)) (:foreground "chartreuse")) (((type tty) (class color)) (:foreground "chartreuse"))))
