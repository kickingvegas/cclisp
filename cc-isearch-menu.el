...
(transient-define-prefix cc/isearch-menu ()
  ...
  [["Edit Search String"
    ...
    ("w" "Pull next word or character word from buffer" isearch-yank-word-or-char :transient nil)
    ...
    ("t" "Pull object from buffer" isearch-forward-thing-at-point :transient nil)]

   ["Replace"
    ("q" "Start ‘query-replace’" isearch-query-replace :transient n)
    ("x" "Start ‘query-replace-regexp’" isearch-query-replace-regexp :transient n)]
